...
function hideTrack(currentTiming)
    ...
    track.setColor(255, 255, 255, Ease.Linear(BaseAlpha, 0, p))
    criticalLine.setColor(255, 255, 255, Ease.Linear(BaseAlpha, 0, p))
    divideLine01.setColor(255, 255, 255, Ease.Linear(BaseAlpha, 0, p))
    divideLine12.setColor(255, 255, 255, Ease.Linear(BaseAlpha, 0, p))
    divideLine23.setColor(255, 255, 255, Ease.Linear(BaseAlpha, 0, p))
    divideLineReverse01.setColor(255, 255, 255, Ease.Linear(BaseAlpha, 0, p))
    divideLineReverse12.setColor(255, 255, 255, Ease.Linear(BaseAlpha, 0, p))
    divideLineReverse23.setColor(255, 255, 255, Ease.Linear(BaseAlpha, 0, p))
    local pd = (currentTiming - BaseTiming) / 250
    darkenbg.setColor(0, 0, 0, Ease.Linear(255-BaseAlpha, 255, pd))
end
